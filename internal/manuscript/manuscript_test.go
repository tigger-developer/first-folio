...
func TestUSManuscriptOverridesBritishWithoutChangingPageSize(t *testing.T) {
	...
	assertContains(t, typst, `font: "Menlo", size: 10pt, weight: "regular", stretch: 100%, style: "normal", tracking: 0em`)
...
func TestRenderInlineMarkup(t *testing.T) {
	...
	got := renderInlineMarkup("Dialogue begins --- like this -- then continues with **bold**, *italic*, and `kevin_murray`.")
